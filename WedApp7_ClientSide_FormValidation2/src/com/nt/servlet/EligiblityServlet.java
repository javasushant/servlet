...
//		
		...
		if(gender.equalsIgnoreCase("M")) {
			if(age<21)
				...
				pw.println("<h1 style = 'background-color:aqua ; text-align:center'>Line  3  Mr  "+name+" u r  eligible to get marry but think twice </h1>");
			...
			if(age<18)
				...
				pw.println("<h1 style = 'background-color:aqua ; text-align:center'>Line 6  Ms  "+name+" u r eligible to marry but think thrice</h1>");
